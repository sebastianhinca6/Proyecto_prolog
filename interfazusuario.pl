...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  interfaz_principal:-new(@main,dialog('Sistema Experto Apocalipsis Zombie',
        size(1000,1000))),
        new(@texto, label(nombre,'Tus días sobreviviendo al Apocalipsis son:',font('times','roman',18))),
        new(@resp1, label(nombre,'',font('times','roman',32))),
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  crea_interfaz_inicio:- new(@interfaz,dialog('Bienvenido al Apocalipsis',
  size(1000,1000))),
